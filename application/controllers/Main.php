...
class Main extends CI_Controller {
	...
	{
		$var['var_judul']	= 'Welcome to Future Leader Summit 2016';
	...
	public function testimoni1(){
		$var['var_judul']		= "Testimonial Dari Alumni FLS";
		$var['deskripsi'] 		= "Testimonial Dari Alumni FLS";
		$var['var_breadcumb'] 	= array("Home","Testimoni","Alumni");
		//$var['var_breadcumb'] 	= null;
		$var['slider'] 			= null;
		$var['var_custom_css'] 	= 'foto_kegiatan';
		$var['var_custom_js'] 	= 'foto_kegiatan';
		$var['modul'] 			= "layout/testimoni/ana";
		$this->load->view('home', $var);
	}
	...
	public function testimoni2(){
		...
		$var['var_custom_css'] 	= 'foto_kegiatan';
		$var['var_custom_js'] 	= 'foto_kegiatan';
		$var['modul'] 			= "layout/testimoni/ibnu";
		$this->load->view('home', $var);
	}
	public function testimoni3(){
		$var['var_judul']		= "Testimonial Dari Alumni FLS";
		$var['deskripsi'] 		= "Testimonial Dari Alumni FLS";
		$var['var_breadcumb'] 	= array("Home","Testimoni","Alumni");
		//$var['var_breadcumb'] 	= null;
		...
		$var['var_custom_css'] 	= 'foto_kegiatan';
		$var['var_custom_js'] 	= 'foto_kegiatan';
		$var['modul'] 			= "layout/testimoni/akbar";
		$this->load->view('home', $var);
	}

	public function pembicara(){
		$var['var_judul']		= "Pembicara Future Leader Summit";
		$var['deskripsi'] 		= "Pembicara Future Leader Summit";
		$var['var_breadcumb'] 	= array("Home","Pembicara");
		//$var['var_breadcumb'] 	= null;
		$var['slider'] 			= null;
		$var['var_custom_css'] 	= 'foto_kegiatan';
		$var['var_custom_js'] 	= 'foto_kegiatan';
		$var['modul'] 			= "event/pembicara";
		$this->load->view('home', $var);
	}
