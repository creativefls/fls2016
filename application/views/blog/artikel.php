    <!--=== Blog Posts ===-->
    <div class="container content-md wow animated fadeInUp">
        <div class="row">
            <!-- Blog All Posts -->
            <div class="col-md-9">
                <!-- News v3 -->
                <div class="row margin-bottom-20">
                    <div class="col-sm-5 sm-margin-bottom-20">
                        <img class="img-responsive" src="<?=base_url(); ?>assets/img/main/img12.jpg" alt="">
                    </div>
                    <div class="col-sm-7 news-v3">
                        <div class="news-v3-in-sm no-padding">
                            ...
                            <h2><a href="<?=base_url(); ?>main/artikel">Incredible standard post “IMAGE”</a></h2>
                        ...
                        <div class="carousel slide" data-ride="carousel" id="blog-carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="<?=base_url(); ?>assets/img/main/img19.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="<?=base_url(); ?>assets/img/main/img3.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="<?=base_url(); ?>assets/img/main/img24.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row margin-bottom-20">
                    <div class="col-sm-5 sm-margin-bottom-20">
                        <div class="responsive-video">
                            <iframe src="http://player.vimeo.com/video/93094247?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="col-sm-7 news-v3">
                        <div class="news-v3-in-sm no-padding">
                ...
                <div class="row margin-bottom-20">
                    <div class="col-sm-5 sm-margin-bottom-20">
                        <img class="img-responsive" src="<?=base_url(); ?>assets/img/main/img18.jpg" alt="">
                    </div>
                    <div class="col-sm-7 news-v3">
                        <div class="news-v3-in-sm no-padding">
                            <ul class="list-inline posted-info">
                ...
                <div class="row margin-bottom-20">
                    <div class="col-sm-5 sm-margin-bottom-20">
                        <img class="img-responsive" src="<?=base_url(); ?>assets/img/main/img3.jpg" alt="">
                    </div>
                    <div class="col-sm-7 news-v3">
                        <div class="news-v3-in-sm no-padding">
                            <ul class="list-inline posted-info">
